...
/*     const[isLoading, setIsLoading] = useState(true);
    ...
    const handleSearch = (searchText) =>{
        ...
        const filterCoin = cryptoCoins.filter(coin => coin.Name.includes(searchText));
        console.log(filterCoin);
        setCoinData(filterCoin);
    }
    useEffect(() => {
    ...
    /* const fetchData = async() =>{
        ...
        console.log(`coin maeket data: ${JSON.stringify(data)}`)
        setCoinData(data);
        } catch (error) {
            setError(error)
        }
    ...
    return <>
              <div className="wrapper">
               ...
               <CryptoSearchPanel searchCallback={handleSearch}/>
